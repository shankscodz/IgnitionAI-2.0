...
public class VirtualSensorsTest {
    ...
    private static void testPhase3ExitDemonstration() {
        ...
        inputs.put("engine_coolant_temperature", new SensorReading("engine_coolant_temperature", 85.0, 1000L, "degC"));
        inputs.put("ambient_air_temperature", new SensorReading("ambient_air_temperature", 25.0, 1000L, "degC"));
        
        SensorOutput outSuccess = runtime.evaluate("thermal_response_proxy", inputs, null);
        ...
        SensorOutput outMissing = runtime.evaluate("thermal_response_proxy", inputs, null);
